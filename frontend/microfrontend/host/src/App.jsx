...
const PopupWithForm = lazy(() =>
  import("auth/PopupWithForm").catch(() => {
    return {
...
const ImagePopup = lazy(() =>
  import("photos/ImagePopup").catch(() => {
    return {
      default: () => <div className="error">Component is not available!</div>,
    };
  }),
...
const AddPlacePopup = lazy(() =>
  import("photos/AddPlacePopup").catch(() => {
    return {
      default: () => <div className="error">Component is not available!</div>,
    };
  }),
...
const InfoTooltip = lazy(() =>
  import("photos/InfoTooltip").catch(() => {
    return {
      default: () => <div className="error">Component is not available!</div>,
    };
  }),
...
const EditProfilePopup = lazy(() =>
  import("profile/EditProfilePopup").catch(() => {
    return {
      default: () => <div className="error">Component is not available!</div>,
    };
  }),
...
const EditAvatarPopup = lazy(() =>
  import("profile/EditAvatarPopup").catch(() => {
    return {
      default: () => <div className="error">Component is not available!</div>,
    };
  }),
